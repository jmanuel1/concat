...
class TestCombinators(unittest.TestCase):
    ...
    def __test_function_2(self, stack: List[object], stash: List[object]) -> None:
        stack.append(42)

    def test_choose(self) -> None:
        stack = [False, self.__test_function, self.__test_function_2]
        concat.level1.stdlib.execution.choose(stack, [])
