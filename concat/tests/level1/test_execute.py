...
class TestExecute(unittest.TestCase):
    ...
    def test_preamble(self) -> None:
        ...
        for name in ['to_int', 'to_bool', 'to_complex', 'len', 'getitem', 'to_float', 'decode_bytes', 'to_tuple', 'to_bytes', 'to_list', 'to_bytearray', 'to_set', 'add_to_set', 'to_frozenset', 'to_dict', 'user_defined_function']:
